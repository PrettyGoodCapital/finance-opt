...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_opt
	python -m ruff format --check finance_opt
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_opt
	python -m ruff format finance_opt
...
test-py:  ## run python tests
	python -m pytest -v finance_opt/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_opt/tests --cov=finance_opt --cov-report term-missing --cov-report xml
